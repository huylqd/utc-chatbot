...
add_normal(doc, 'Để thử nghiệm hệ thống, bộ dữ liệu hành chính tại Đại Học Giao Thông Vận Tải được sử dụng. Các file dữ liệu được ban hành từ các phòng ban chính thức của Học viện.')
...
add_bullet(doc, 'Xây dựng thành công nền tảng Chatbot thông minh phục vụ tra cứu thông tin học vụ, quy chế đào tạo, thủ tục hành chính và tài liệu nội bộ tại Đại Học Giao Thông Vận Tải.')
