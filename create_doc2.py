...
add_normal(doc, 'Hệ thống áp dụng chiến lược thu thập và phân loại dữ liệu theo cơ cấu tổ chức hành chính của Học viện Kỹ thuật Mật mã, bao gồm ba nhóm phòng ban chính:')
